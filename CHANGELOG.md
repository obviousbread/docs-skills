...
- Documentation and metadata cleanup. No functional changes; supersedes 0.3.0–0.3.1.
...
- Generalized skill references (`docs-di/references/knowledge_base.md`, `docs-di/references/quality-checklist.md`) to use «профильные информационные системы».

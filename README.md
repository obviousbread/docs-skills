...
<p align="center">
  Набор скиллов для ИИ-агентов для создания официальных документов и подготовки связанных рабочих данных.
</p>
...
- `docs-staff-list` — консолидация кадровых `.xls`/`.xlsx` в единый сводный список.
...
Требования: Python 3, `python-docx` и `openpyxl`. Для `docs-staff-list` также нужны `pandas` и `xlrd` (последний — для `.xls`).
